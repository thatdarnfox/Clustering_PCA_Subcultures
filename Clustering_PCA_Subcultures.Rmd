...
Before delving into clustering or principal component analysis, it would be useful to get a basic idea of some of the characteristics of the respondents in the data set. To do so, I plot the distributions of some relevant variables in the following pages.
...
It appears the average level of schooling for a respondent was equivalent to high-school education. The second most common education level for the respondents was a bachelor's degree, followed by what appears to be a tie between respondents who have completed a master's degree and those who have completed elementary/middle school. A small number of respondents had either a doctorate or were currently enrolled as a primary school student. The fact that high-school graduates make up over 50% of the respondents is not unexpected; given how the survey was administered, one would expect the average respondent to be someone who is in the process of completing a college degree.
...
In this section, I use an application of clustering to identify some subcultures that are present in the university population's student body, but unapparent in the survey data. My intention is to first focus my analysis on patterns within *the observations* before turning to the columns of the data set. 
